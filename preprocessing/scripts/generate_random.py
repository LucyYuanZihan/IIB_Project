...
def process_scene_global(
    ...
    pts_list, intens_list = [], []
    for p in txt_paths:
        P, I, _ = load_txt_point_cloud(p)
        pts_list.append(P)
    ...
    for variant_idx in range(num_variants):
        ...
        # --- random downsample for this variant ---
        if num_points is None:
            idx = np.arange(N_total)
        elif N_total >= num_points:
...
def parse_args():
    ...
    ap.add_argument(
        "--input_dir",
        type=str, 
        default =  "/mnt/c/Users/zy349/Documents/Points2NeRF/Seg2Tunnel/T1/1-9",
        # default =  "./exp/T1",
    ...
    ap.add_argument(
        "--output_dir",
        type=str,
        default="/mnt/c/Users/zy349/Documents/Points2NeRF/Seg2Tunnel_my_data_1024/T1",
    ...
    ap.add_argument(
        ...
        type=int,
        default=8,
        help="Number of different random downsampled point clouds per .txt file.",
    )
